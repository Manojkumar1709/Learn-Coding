...
### b. If a number is divisible by one or more numbers, the program should print the divisors. If it is not divisible by any of the numbers from 2 to 100, print a message stating that it is not divisible by any of the specified numbers.
